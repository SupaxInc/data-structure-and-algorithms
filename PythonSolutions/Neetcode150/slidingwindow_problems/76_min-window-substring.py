...
class Solution:
    def minWindow(self, s: str, t: str) -> str:
        ...
        have, need = (
            0,
            len(tCount),
        )  # The amount of letters we have compared to what we need
        res, resLen = (
            [0, 0],
            float("infinity"),
        )  # Keep track of start and end of the result as well as the length
        for end in range(len(s)):
            ...
            while have == need:
                ...
                sCount[s[start]] -= 1
                # Check if the current start char no longer satisfies the frequency of string t
